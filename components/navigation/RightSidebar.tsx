...
const popularTags = [
  ...
  { _id: "6", name: "redux", questions: 25 },
];

const RightSidebar = () => {
  return (
    <section className="custom-scrollbar background-light900_dark200 sticky right-0 top-0 flex h-screen w-[350px] flex-col gap-6 overflow-y-auto  p-6 pt-36 shadow-light-300 dark:shadow-none max-xl:hidden">
      <div>
